   ...
   <div class="row">
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="{{route('order.index')}}" class="small-box-footer">Ver Todos <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
        <!-- ./col -->        
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="{{ route('customer.index') }}" class="small-box-footer">Ver más <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
       <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="{{ route('cart.index') }}" class="small-box-footer">Ver más <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
    </div>

                            ...
                            <div class="tab-pane active fade in active" id="tab_1">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <input type="text" name="code" class="form-control" value="{{ old('code')}}"  id="value-code">
                                        <span>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-12">
                                        ...
                                        <input type="text" name="start" class="form-control datepicker" value="{{ old('start')}}" autocomplete="off"><br>
                                    </div>
                                    <div class="col-lg-4 col-sm-12">
                                        <label>Fecha final</label>
                                        <input type="text" name="end" class="form-control datepicker" value="{{ old('end')}}" autocomplete="off">
                                        <br>
                                    </div>
                                    <div class="col-lg-4 col-sm-12">
                                        <label>Tipo</label>
                                        <select name="limited" class="form-control" id="select-limited">
                                            <option value="0" {{ old('limited') == '0' ? 'selected' : ''}}>Ilimitado</option>
                                            <option value="1" {{ old('limited') == '1' ? 'selected' : ''}}>Cantidad</option>
                                        </select><br>
                                    </div>
                                </div> 
                                <div class="" id="quantity" style="display: none;">
                                    <label>Cantidad</label>
                                    <input type="text" name="quantity" class="form-control" value="{{ old('quantity')}}" autocomplete="off"><br>
                                </div> 
                                <div>
                                    ...
                                    <div class="typeahead__container">
                                        <div class="typeahead__field">
                                            ...
                                            <input type="text" name="_email_customer" class="form-control js-typeahead-user-coupon" value="{{ old('_email_customer')}}" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="number" name="min_quantity" class="form-control" value="{{ old('min_quantity') == '' ? 1 : old('min_quantity') }}"><br>
                                    </div>
                                    <div class="col-lg-6 col-sm-12">
                                         <label>Valor mínimo de la compra</label>
                                        <input type="number" name="min_amount" class="form-control" value="{{ old('min_amount') == '' ? 0 : old('min_amount')}}"><br>
                                    </div>
                                </div>   
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="number" name="discount" class="form-control" value="{{ old('discount') == '' ? 0 : old('discount')}}" id="discount"  step="0.01">
...
@push('js')
    ...
    <script>
        ...
        let val = new String (Math.random().toString(36).substring(2,10));
        val.toUpperCase();

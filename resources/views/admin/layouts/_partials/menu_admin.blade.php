...
<li><a href="{{ route('faqcategories.index') }}"><i class="fa fa-question"></i> <span>Preguntas frecuentes</span></a></li> 
<li class="header">Tienda</li>

<li><a href="{{ route('categories.index') }}"><i class="fa fa-c"></i> <span>Categorías</span></a></li> 
<li><a href="{{ route('products.index') }}"><i class="fa fa-p"></i> <span>Productos</span></a></li> 
<li><a href="{{ route('attributes.index') }}"><i class="fa fa-a"></i> <span>Atributos</span></a></li> 

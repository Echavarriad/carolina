...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Version Laravel</b> {{ config('app.version_laravel') }} | <b>Version PHP</b> {{config('app.version_php')}}
    </div>
...
@if (strpos(request()->route()->getName(), 'gallery') === false)
...
<script>
  ...
  $(document).on('click', '.btn-delete', function(event) {
      ...
      Swal.fire({
          ...
          html: '<span style="font-size:21px;font-weight:bold; color : #3c8dbc">' + name + ' </span><br><p style="color:red">' + note + '</p>',

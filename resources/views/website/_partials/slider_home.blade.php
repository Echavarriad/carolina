<section>
    <div class="slider_content_two left fade">
        <picture>
            <x-image image="{{ $section->contents[0]->image_1 }}" alt="{{ $section->contents[0]->alt_1 }}"
                tit="{{ $section->contents[0]->tit_1 }}" class="" width="100%"></x-image>
        </picture>
    </div>
    <div class="slider_content_two left fade">
        <picture>
    ...
    <div class="main-text_banner">
        <h3>Find the perfect shade for you once...</h3>
    </div>

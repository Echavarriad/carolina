...
class MakeEditBladeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:edit.blade {name}';
     ...
     * @var string
     */
    protected $description = 'Make an edit blade view';
    ...
    {
        return __DIR__ . '/../../../stubs/edit_blade.stub';
    }
    ...
    */
    ...
    public function getSourceFilePath()
    {
        ...
        return base_path('resources\\views\\admin\\' . $folder) .'\\'  . 'edit.blade.php';
    }

...
class MakeRequestCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:my_request {name}';
    ...
    {
        return __DIR__ . '/../../../stubs/my_request.stub';
    }
    ...
    */
    ...
    {
        return base_path('App\\Http\\Requests') .'\\' .$this->getSingularClassName($this->argument('name')) . 'Request.php';
    }

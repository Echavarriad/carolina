...
class MakeGalleryBladeCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:gallery.blade {name}';
     ...
     * @var string
     */
    protected $description = 'Make an gallery blade view';
    ...
    {
        return __DIR__ . '/../../../stubs/gallery_blade.stub';
    }
    ...
    */
    ...
    public function getSourceFilePath()
    {
        ...
        return base_path('resources\\views\\admin\\' . $folder) .'\\'  . 'gallery.blade.php';
    }
